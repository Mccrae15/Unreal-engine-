...
cd %PS4_BUILD_PATH%
cmake -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="Debug" -DCMAKE_TOOLCHAIN_FILE="%PATH_TO_CMAKE_FILE%\PS4\HarfbuzzOrbis.cmake" -DUSE_STUB_GETENV=TRUE %PATH_TO_CMAKE_FILE%
echo Building HarfBuzz for PS4 (Debug)...
nmake harfbuzz
mkdir "%PS4_BUILD_PATH%\..\Debug" 2> nul
...
mkdir %PS4_BUILD_PATH%
cd %PS4_BUILD_PATH%
cmake -G "NMake Makefiles" -DCMAKE_BUILD_TYPE="Release" -DCMAKE_TOOLCHAIN_FILE="%PATH_TO_CMAKE_FILE%\PS4\HarfbuzzOrbis.cmake" -DUSE_STUB_GETENV=TRUE %PATH_TO_CMAKE_FILE%
echo Building HarfBuzz makefile for PS4 (Release)...
nmake harfbuzz
mkdir "%PS4_BUILD_PATH%\..\Release" 2> nul
