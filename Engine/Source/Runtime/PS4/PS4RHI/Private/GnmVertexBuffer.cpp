...
void* FGnmDynamicRHI::RHILockVertexBuffer(FRHIVertexBuffer* VertexBufferRHI, uint32 Offset, uint32 Size, EResourceLockMode LockMode)
{
...
void FGnmDynamicRHI::RHIUnlockVertexBuffer(FRHIVertexBuffer* VertexBufferRHI)
{
	FGnmVertexBuffer* VertexBuffer = ResourceCast(VertexBufferRHI);
