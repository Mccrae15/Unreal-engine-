...
void FPS4MediaTracks::SetDesiredTrack(EMediaTrackType TrackType, int32 TrackIndex)
{
	switch (TrackType)
	{
	case EMediaTrackType::Audio:
		DesiredAudioTrack = TrackIndex;
		break;

	case EMediaTrackType::Caption:
		DesiredCaptionTrack = TrackIndex;
		break;

	case EMediaTrackType::Video:
		DesiredVideoTrack = TrackIndex;
		break;
	}
}
