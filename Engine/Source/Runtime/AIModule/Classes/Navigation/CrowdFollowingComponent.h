...
/** CARBON edit ONLY Exposed many variables */
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bAffectFallingVelocity : 1;

	/** if set, move focus will match velocity direction */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bRotateToVelocity : 1;

	/** if set, move velocity will be updated in every tick */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bUpdateDirectMoveVelocity : 1;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bRegisteredWithCrowdSimulation : 1;

	/** if set, avoidance and steering will be suspended (used for direct move requests) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bSuspendCrowdSimulation : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableAnticipateTurns : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableObstacleAvoidance : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableSeparation : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableOptimizeVisibility : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableOptimizeTopology : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnablePathOffset : 1;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")
	uint32 bEnableSlowdownAtGoal : 1;

	/** if set, agent if moving on final path part, skip further updates (runtime flag) */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bFinalPathPart : 1;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bCheckMovementAngle : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	uint32 bEnableSimulationReplanOnResume : 1;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	float SeparationWeight;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	float CollisionQueryRange;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	float PathOptimizationRange;

	/** multiplier for avoidance samples during detection, doesn't affect actual velocity */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	float AvoidanceRangeMultiplier;

	/** start index of current path part */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	int32 PathStartIndex;

	/** last visited poly on path */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Crowd")	int32 LastPathPolyIndex;
