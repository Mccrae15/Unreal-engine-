...
:SKIPSCEROOTOVERRIDE
echo SCE_ORBIS_SDK_DIR=%CurrentFolder%NotForLicensees\5.000>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo SCE_ORBIS_SAMPLE_DIR=%CurrentFolder%NotForLicensees\5.000\target\samples>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
...
call "%CurrentFolder%NotForLicensees\Installers\TMServer-5_00_0_10.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_38_0_6862.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\Neighborhood-5_00_0_15.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\DebuggerRunnerForPS_ORBIS-5_00_0_9.exe" -install -silent
rmdir /s /q "C:\ProgramData\SCE\PSFSD"
