...
:SKIPSCEROOTOVERRIDE
echo SCE_ORBIS_SDK_DIR=%CurrentFolder%NotForLicensees\4.500>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo SCE_ORBIS_SAMPLE_DIR=%CurrentFolder%NotForLicensees\4.500\target\samples>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
...
call "%CurrentFolder%NotForLicensees\Installers\TMServer-4_50_1_1.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_12_0_6571.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\Neighborhood-4_50_0_21.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\DebuggerRunnerForPS_ORBIS-4_50_0_18.exe" -install -silent
rmdir /s /q "C:\ProgramData\SCE\PSFSD"
