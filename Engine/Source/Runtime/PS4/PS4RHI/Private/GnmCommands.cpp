...
void FGnmDynamicRHI::RHISetStreamOutTargets(uint32 NumTargets, FRHIVertexBuffer* const* VertexBuffers, const uint32* Offsets)
{
}
...
void FGnmCommandListContext::RHISetShaderTexture(FRHIVertexShader* VertexShaderRHI, uint32 TextureIndex, FRHITexture* NewTextureRHI)
{
...
/** Set the shader resource view of a surface.  This is used for binding TextureMS parameter types that need a multi sampled view. */
void FGnmCommandListContext::RHISetShaderTexture(FRHIHullShader* HullShader, uint32 TextureIndex, FRHITexture* NewTextureRHI)
{
	SetTextureForStage(NewTextureRHI, TextureIndex, Gnm::kShaderStageHs);
}

/** Set the shader resource view of a surface.  This is used for binding TextureMS parameter types that need a multi sampled view. */
void FGnmCommandListContext::RHISetShaderTexture(FRHIDomainShader* DomainShader, uint32 TextureIndex, FRHITexture* NewTextureRHI)
{
...
/** Set the shader resource view of a surface.  This is used for binding TextureMS parameter types that need a multi sampled view. */
void FGnmCommandListContext::RHISetShaderTexture(FRHIGeometryShader* GeometryShader, uint32 TextureIndex, FRHITexture* NewTextureRHI)
{
	SetTextureForStage(NewTextureRHI, TextureIndex, Gnm::kShaderStageGs);
}

/** Set the shader resource view of a surface.  This is used for binding TextureMS parameter types that need a multi sampled view. */
void FGnmCommandListContext::RHISetShaderTexture(FRHIPixelShader* PixelShader, uint32 TextureIndex, FRHITexture* NewTextureRHI)
{
...
void FGnmCommandListContext::RHISetShaderResourceViewParameter(FRHIVertexShader* VertexShaderRHI, uint32 TextureIndex, FRHIShaderResourceView* SRVRHI)
{
	FGnmVertexShader* VertexShader = ResourceCast(VertexShaderRHI);
	SetSRVForStage(SRVRHI, TextureIndex, VertexShader->ShaderStage);
}

void FGnmCommandListContext::RHISetShaderResourceViewParameter(FRHIHullShader* HullShaderRHI, uint32 TextureIndex, FRHIShaderResourceView* SRVRHI)
{
	SetSRVForStage(SRVRHI, TextureIndex, Gnm::kShaderStageHs);
}

void FGnmCommandListContext::RHISetShaderResourceViewParameter(FRHIDomainShader* DomainShaderRHI, uint32 TextureIndex, FRHIShaderResourceView* SRVRHI)
{
	// @todo gnm this is probably the wrong stage
	SetSRVForStage(SRVRHI, TextureIndex, Gnm::kShaderStageEs);
}

void FGnmCommandListContext::RHISetShaderResourceViewParameter(FRHIGeometryShader* GeometryShaderRHI, uint32 TextureIndex, FRHIShaderResourceView* SRVRHI)
{
	SetSRVForStage(SRVRHI, TextureIndex, Gnm::kShaderStageGs);
}

void FGnmCommandListContext::RHISetShaderResourceViewParameter(FRHIPixelShader* PixelShaderRHI, uint32 TextureIndex, FRHIShaderResourceView* SRVRHI)
{
...
void FGnmCommandListContext::RHISetShaderSampler(FRHIVertexShader* VertexShaderRHI, uint32 SamplerIndex, FRHISamplerState* NewStateRHI)
{
...
void FGnmCommandListContext::RHISetShaderSampler(FRHIHullShader* HullShader, uint32 SamplerIndex, FRHISamplerState* NewStateRHI)
{
	FGnmSamplerState* NewState = ResourceCast(NewStateRHI);
...
void FGnmCommandListContext::RHISetShaderSampler(FRHIDomainShader* DomainShader, uint32 SamplerIndex, FRHISamplerState* NewStateRHI)
{
	FGnmSamplerState* NewState = ResourceCast(NewStateRHI);
...
void FGnmCommandListContext::RHISetShaderSampler(FRHIGeometryShader* GeometryShader, uint32 SamplerIndex, FRHISamplerState* NewStateRHI)
{
	FGnmSamplerState* NewState = ResourceCast(NewStateRHI);
...
void FGnmCommandListContext::RHISetShaderSampler(FRHIPixelShader* PixelShader, uint32 SamplerIndex, FRHISamplerState* NewStateRHI)
{
	FGnmSamplerState* NewState = ResourceCast(NewStateRHI);
...
void FGnmCommandListContext::RHISetShaderParameter(FRHIVertexShader* VertexShaderRHI, uint32 BufferIndex, uint32 BaseIndex, uint32 NumBytes, const void* NewValue)
{
	UpdateVSConstant(BufferIndex, NewValue, BaseIndex, NumBytes);
}

void FGnmCommandListContext::RHISetShaderParameter(FRHIHullShader* HullShaderRHI, uint32 BufferIndex, uint32 BaseIndex, uint32 NumBytes, const void* NewValue)
{
	UpdateHSConstant(BufferIndex, NewValue, BaseIndex, NumBytes);
}

void FGnmCommandListContext::RHISetShaderParameter(FRHIPixelShader* PixelShaderRHI, uint32 BufferIndex, uint32 BaseIndex, uint32 NumBytes, const void* NewValue)
{
	UpdatePSConstant(BufferIndex, NewValue, BaseIndex, NumBytes);
}

void FGnmCommandListContext::RHISetShaderParameter(FRHIDomainShader* DomainShaderRHI, uint32 BufferIndex, uint32 BaseIndex, uint32 NumBytes, const void* NewValue)
{
	UpdateDSConstant(BufferIndex, NewValue, BaseIndex, NumBytes);
}

void FGnmCommandListContext::RHISetShaderParameter(FRHIGeometryShader* GeometryShaderRHI, uint32 BufferIndex, uint32 BaseIndex, uint32 NumBytes, const void* NewValue)
{
...
void FGnmCommandListContext::RHISetShaderUniformBuffer(FRHIVertexShader* VertexShaderRHI, uint32 BufferIndex, FRHIUniformBuffer* BufferRHI)
{
...
void FGnmCommandListContext::RHISetShaderUniformBuffer(FRHIHullShader* HullShader, uint32 BufferIndex, FRHIUniformBuffer* BufferRHI)
{
	FGnmUniformBuffer* Buffer = ResourceCast(BufferRHI);
	if (Buffer && Buffer->IsConstantBuffer())
	{
...
void FGnmCommandListContext::RHISetShaderUniformBuffer(FRHIDomainShader* DomainShader, uint32 BufferIndex, FRHIUniformBuffer* BufferRHI)
{
	FGnmUniformBuffer* Buffer = ResourceCast(BufferRHI);
	if (Buffer && Buffer->IsConstantBuffer())
	{
...
void FGnmCommandListContext::RHISetShaderUniformBuffer(FRHIGeometryShader* GeometryShader, uint32 BufferIndex, FRHIUniformBuffer* BufferRHI)
{
	FGnmUniformBuffer* Buffer = ResourceCast(BufferRHI);
	if (Buffer && Buffer->IsConstantBuffer())
	{
...
void FGnmCommandListContext::RHISetShaderUniformBuffer(FRHIPixelShader* PixelShader, uint32 BufferIndex, FRHIUniformBuffer* BufferRHI)
{
	FGnmUniformBuffer* Buffer = ResourceCast(BufferRHI);
	if (Buffer && Buffer->IsConstantBuffer())
	{
...
void FGnmCommandListContext::SetRenderTargets_Impl(uint32 NumSimultaneousRenderTargets, const FRHIRenderTargetView* NewRenderTargets, const FRHIDepthRenderTargetView* NewDepthStencilTarget, uint32 NumUAVs, FRHIUnorderedAccessView* const* UAVs, bool bHWColorRequired, bool bHWDepthRequired)
{
	RequestRenderTargetVerification();
	...
	// We overload the number of color targets to represent the starting bindpoint of the UAVs.
	uint32 UAVBindIndex = NumSimultaneousRenderTargets;
	check(UAVBindIndex < MaxSimultaneousUAVs && (UAVBindIndex + NumUAVs) <= MaxSimultaneousUAVs);
	for (uint32 UAVIndex = 0; UAVIndex < NumUAVs; UAVIndex++)
	{
		...
		if (UAV)
		{
			//check it's safe for r/w for this UAV
			const EResourceTransitionAccess CurrentUAVAccess = UAV->GetResourceAccess();
			const bool UAVDirty = UAV->IsResourceDirty() && UAV->GetLastFrameWritten() != CurrentFrame;// When setting an UAV multiple times each frame, only the first time do this check
			ensureMsgf((CurrentUAVAccess == EResourceTransitionAccess::ERWBarrier && !UAVDirty) || (CurrentUAVAccess == EResourceTransitionAccess::ERWNoBarrier && !UAVDirty), TEXT("UAV: %i is in unsafe state for GPU R/W: %s"), UAVBindIndex, *FResourceTransitionUtility::ResourceTransitionAccessStrings[(int32)CurrentUAVAccess]);

			TrackResource(sce::Shader::Binary::kInternalBufferTypeUav, UAVBindIndex, Gnm::kShaderStagePs);
			...
			AddDeferredPixelShaderUAV(UAVBindIndex, UAV);
			UAVBindIndex++;
...
void FGnmCommandListContext::RHISetRenderTargets(uint32 NumSimultaneousRenderTargets, const FRHIRenderTargetView* NewRenderTargets,
	const FRHIDepthRenderTargetView* NewDepthStencilTarget, uint32 NumUAVs, FRHIUnorderedAccessView* const* UAVs)
{
...
void FGnmCommandListContext::RHISetRenderTargetsAndClear(const FRHISetRenderTargetsInfo& RenderTargetsInfo)
{
	...
	// Bind UAVs if present.
	int32 NumUAVs = RenderTargetsInfo.NumUAVs;
...
void FGnmCommandListContext::RHICopyToStagingBuffer(FRHIVertexBuffer* SourceBufferRHI, FRHIStagingBuffer* DestinationStagingBufferRHI, uint32 Offset, uint32 NumBytes)
{
	...
	void* SourceBacking = Source->GetCurrentBuffer();
...
void FGnmCommandListContext::ClearColorTargetsByHardware(FRHICommandList_RecursiveHazardous& RHICmdList, int32 NumClearColors, const FLinearColor* ClearColorArray)
{
	...
	if (bNonCMaskTargetsToClear)
	{
		for (int32 RTIndex = 0; RTIndex < NumActiveRenderTargets; RTIndex++)
		{
			...
			// possible for UAVTexture to be NULL here
			if (RTSurface->getCmaskAddress() == NULL && UAVTexture != NULL)
			{
...
void FGnmCommandListContext::ClearColorTargetsByShader(FRHICommandList_RecursiveHazardous& RHICmdList, int32 NumClearColors, const FLinearColor* ClearColorArray)
{
	...
	Bounds.W = FMath::Min((float)CachedViewportScissorMaxY, Bounds.W);	
