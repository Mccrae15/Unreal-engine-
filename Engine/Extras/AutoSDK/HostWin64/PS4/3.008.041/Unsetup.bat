...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\TMServer-3_00_0_23.msi" /norestart /quiet
...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\PublishingTools-2_08_0_4378.msi" /norestart /quiet
REM CALL :HANDLE_ERROR
