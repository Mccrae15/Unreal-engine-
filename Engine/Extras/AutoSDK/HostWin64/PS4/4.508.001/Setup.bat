...
call "%CurrentFolder%NotForLicensees\Installers\TMServer-4_50_0_27.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-2_89_0_6124.msi" /norestart /quiet
