...
/**
 * Sony implementation of the Atomics OS functions.
 */
struct CORE_API FSonyPlatformAtomics : public FGenericPlatformAtomics
{
...
typedef FSonyPlatformAtomics FPlatformAtomics;