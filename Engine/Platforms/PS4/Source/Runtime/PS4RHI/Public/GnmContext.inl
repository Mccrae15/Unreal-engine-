...
FORCEINLINE void FGnmCommandListContext::SetViewportAndGuardBand(float MinX, float MinY, float MinZ, float MaxX, float MaxY, float MaxZ, float ZScale, float ZOffset)
{
...
FORCEINLINE void FGnmCommandListContext::SetViewport(float MinX, float MinY, float MinZ, float MaxX, float MaxY, float MaxZ)
{
...
FORCEINLINE void FGnmCommandListContext::SetStereoViewport(float LeftMinX, float RightMinX, float LeftMinY, float RightMinY, float MinZ, float LeftMaxX, float RightMaxX, float LeftMaxY, float RightMaxY, float MaxZ)
{
...
*/
FORCEINLINE void FGnmCommandListContext::SetViewportUncached(float MinX, float MinY, float MinZ, float MaxX, float MaxY, float MaxZ, float ZScale, float ZOffset)
{
...
FORCEINLINE void FGnmCommandListContext::SetDepthStencilState(FGnmDepthStencilState* NewState, uint8 StencilRef)
{
	...
	{
		GnmContext->setDepthStencilControl(NewState->DepthStencilState);
...
FORCEINLINE void FGnmCommandListContext::RHIEnableDepthBoundsTest(bool bEnable)
{
...
FORCEINLINE void FGnmCommandListContext::RHISetDepthBounds(float MinDepth, float MaxDepth)
{
	Gnm::DepthStencilControl DepthStencilState = CachedDepthStencilState;
