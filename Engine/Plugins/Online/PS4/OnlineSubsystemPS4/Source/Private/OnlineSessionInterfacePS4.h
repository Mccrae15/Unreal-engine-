...
typedef FAutoDeleteAsyncTask<FOnlineAsyncTaskPS4SessionDestroy> FAutoDeleteSessionDestroyTask;
...
typedef FAutoDeleteAsyncTask<FOnlineAsyncTaskPS4SessionLeave> FAutoDeleteSessionLeaveTask;
...
public:
	...
	*/
	FOnlineAsyncTaskPS4SessionPutSession(FOnlineSubsystemPS4 * InPS4Subsystem, int32 InUserWebApiContext, const FUniqueNetIdString* InSessionId, const FOnlineSessionSettings& InUpdatedSessionSettings)
		: PS4Subsystem(InPS4Subsystem), UserWebApiContext(InUserWebApiContext), SessionId(InSessionId->ToString(), InSessionId->GetType()), UpdatedSessionSettings(InUpdatedSessionSettings)
	{
...
public:
	...
	virtual FString ToString() const override
	{
		return FString::Printf(TEXT("FAsyncEventSessionDestroyTaskCompleted SessionName: %s bWasSuccessful: %d"), *SessionName.ToString(), bWasSuccessful);
	}
...
public:
	...
	*/
	...
	virtual FString ToString() const override
	{
		return FString::Printf(TEXT("FAsyncEventSessionJoinTaskCompleted SessionName: %s Result: %s"), *SessionName.ToString(), LexToString(Result));
	}
...
public:
	...
	*/
	...
	virtual FString ToString() const override
	{
		return FString::Printf(TEXT("FAsyncEventSessionLeaveTaskCompleted SessionName: %s bWasSuccessful: %d"), *SessionName.ToString(), bWasSuccessful);
	}
...
public:
	 ...
	 */
	FAsyncEventSessionGetChangeableSessionDataTaskCompleted(FOnlineSubsystemPS4* InPS4Subsystem, TSharedPtr<const FUniqueNetIdPS4> InUserId, FString&& InSessionId, FString&& InChangeableSessionData,
