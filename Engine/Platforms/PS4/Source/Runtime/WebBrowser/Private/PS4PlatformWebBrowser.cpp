...
void SPS4WebBrowserWidget::ShowWebURL(FIntPoint IntPos, FIntPoint IntSize) const
{
	...
	if (!CurrentURL.IsEmpty())
	{
		...
		UOnlineEngineInterface::Get()->ShowWebURL(CurrentURL, Params, FOnlineShowWebUrlClosed::CreateRaw(const_cast<SPS4WebBrowserWidget*>(this), &SPS4WebBrowserWidget::HandleWebURLClosed));
	}
#endif
}
