	...
	namespace Legacy
	{
		...
		public:
			...
			static void Load(FArchive& Ar, TArray<TArray<int32>>& OutPlaneVertices, int32& OutNumVertices)
			{
				...
				bool bUseVariableSizeStructureDataFN = false;//Ar.CustomVer(FFortniteMainBranchObjectVersion::GUID) >= FFortniteMainBranchObjectVersion::ChaosConvexVariableStructureDataAndVerticesArray;
