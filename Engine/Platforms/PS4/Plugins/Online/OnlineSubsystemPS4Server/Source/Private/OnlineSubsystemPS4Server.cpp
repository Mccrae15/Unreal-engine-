...
IOnlineStatsPtr FOnlineSubsystemPS4Server::GetStatsInterface() const
{
	return nullptr;
}
...
IOnlineTournamentPtr FOnlineSubsystemPS4Server::GetTournamentInterface() const
{
	return nullptr;
}
...
{
	UE_LOG_ONLINE(VeryVerbose, TEXT("FOnlineSubsystemPS4Server::Shutdown()"));
