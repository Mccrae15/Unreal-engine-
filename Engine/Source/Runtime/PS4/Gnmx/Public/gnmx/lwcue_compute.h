...
namespace sce
{
	namespace Gnmx
	{
			...
			public:
				 ...
				 *  
				 *  <c>buffer[0]</c> will be bound to <c><i>startApiSlot</i></c>, <c>buffer[1]</c> to <c><i>startApiSlot</i>+1</c>, and so on.
				 ...
				 *
				 *  <c>texture[0]</c> will be bound to <c><i>startApiSlot</i></c>, <c>texture[1]</c> to <c><i>startApiSlot</i>+1</c>, and so on. 
				 ...
				 *
				 *  <c>sampler[0]</c> will be bound to <c><i>startApiSlot</i></c>, <c>sampler[1]</c> to <c><i>startApiSlot</i>+1</c>, and so on. 
				 *
