...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\TMServer-4_50_0_27.msi" /norestart /quiet
...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\PublishingTools-2_83_0_5961.msi" /norestart /quiet
REM CALL :HANDLE_ERROR
