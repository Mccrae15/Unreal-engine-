...
FStructuredBufferRHIRef FGnmDynamicRHI::RHICreateRTWriteMaskBuffer(FRHITexture2D* RenderTarget)
{
...
void FGnmDynamicRHI::RHIVirtualTextureSetFirstMipInMemory(FRHITexture2D* TextureRHI, uint32 FirstMip)
{
	...
	UE_LOG(LogPS4, Fatal, TEXT("RHIVirtualTextureSetFirstMipInMemory(FRHITexture2D* TextureRHI, uint32 FirstMip) needs to be implemented"));
}

void FGnmDynamicRHI::RHIVirtualTextureSetFirstMipVisible(FRHITexture2D* TextureRHI, uint32 FirstMip)
{
	// TODO: Implement for PS4
	UE_LOG(LogPS4, Fatal, TEXT("RHIVirtualTextureSetFirstMipVisible(FRHITexture2D* TextureRHI, uint32 FirstMip) needs to be implemented"));
}
