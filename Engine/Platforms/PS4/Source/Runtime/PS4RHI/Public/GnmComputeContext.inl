...
FORCEINLINE void FGnmComputeCommandListContext::SetTextureForStage(FRHITexture* NewTextureRHI, uint32 TextureIndex, Gnm::ShaderStage Stage)
{
	SetTexture(NewTextureRHI, TextureIndex);
}

FORCEINLINE void FGnmComputeCommandListContext::SetSRVForStage(FRHIShaderResourceView* SRV, uint32 TextureIndex, Gnm::ShaderStage Stage)
{
