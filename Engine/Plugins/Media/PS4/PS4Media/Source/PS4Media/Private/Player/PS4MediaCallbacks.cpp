...
void FPS4MediaCallbacks::Initialize(TSharedPtr<FArchive, ESPMode::ThreadSafe> InArchive, const FString& Url, bool Precache, int32 NumVideoBuffers, int32 VideoBufferSizeMB, bool ShouldLoop)
{
...
bool FPS4MediaCallbacks::InitializeSource(TSharedPtr<FArchive, ESPMode::ThreadSafe> InArchive, const FString& Url, bool Precache, bool ShouldLoop)
{
	...
	sceAvPlayerSetLooping(Handle, ShouldLoop);
