...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\TMServer-3_50_0_55.msi" /norestart /quiet
...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\PublishingTools-2_46_0_5277.msi" /norestart /quiet
REM CALL :HANDLE_ERROR
