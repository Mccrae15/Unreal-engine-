...
#include "PS4/PS4PlatformProperties.h"
...
public:
	...
	virtual bool GenerateStreamingInstallManifest( const TMultiMap<FString, int32>& ChunkMap, const TSet<int32>& PakchunkIndicesInUse ) const override;
