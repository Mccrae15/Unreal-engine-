...
#include <pm4_dump.h>
//#define PRE_DRAW		// GGnmManager.FlushAfterComputeShader(); GGnmManager.FlushBeforeComputeShader();	
...
DECLARE_MEMORY_STAT_POOL_EXTERN(TEXT("Garlic HDR Scopes"), STAT_Garlic_HDRScopes, STATGROUP_PS4RHI, FPlatformMemory::MCR_GPU, );
...
DECLARE_MEMORY_STAT_POOL_EXTERN(TEXT("Onion HDR Scopes"), STAT_Onion_HDRScopes, STATGROUP_PS4RHI, FPlatformMemory::MCR_GPUSystem, );
