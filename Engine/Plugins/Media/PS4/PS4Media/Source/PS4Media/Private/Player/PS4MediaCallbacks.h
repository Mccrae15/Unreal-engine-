...
public:
	 ...
	 */
	void Initialize(TSharedPtr<FArchive, ESPMode::ThreadSafe> InArchive, const FString& Url, bool Precache, int32 NumVideoBuffers, int32 VideoBufferSizeMB, bool ShouldLoop);
