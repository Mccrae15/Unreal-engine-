	...
	FMeshElementCollector& Collector)
{
	...
	int32 ViewCount = InViews.Num();
	{
		...
		const bool bIsInstancedStereo = (ViewCount > 0) ? (InViews[0].IsInstancedStereoPass() || InViews[0].bIsMobileMultiViewEnabled || InViews[0].IsSinglePassStereoAllowed()) : false;
