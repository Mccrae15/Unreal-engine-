...
{
public:
	FOnlineAsyncTaskPS4_DestroySession(FOnlineSubsystemPS4& InPS4Subsystem, int32 InUserWebApiContext, FNamedOnlineSession& InSession, const FOnDestroySessionCompleteDelegate& InCompletionDelegate)
		: PS4Subsystem(InPS4Subsystem)
		, UserWebApiContext(InUserWebApiContext)
		, Session(InSession)
...
{
public:
	FOnlineAsyncTaskPS4_JoinSession(FOnlineSubsystemPS4& InPS4Subsystem, int32 InUserWebApiContext, FNamedOnlineSession& InSession, const FOnlineSessionSearchResult& InDesiredSession)
		: PS4Subsystem(InPS4Subsystem)
		, UserWebApiContext(InUserWebApiContext)
		, Session(InSession)
...
{
public:
	FOnlineAsyncTaskPS4_LeaveSession(FOnlineSubsystemPS4& InPS4Subsystem, int32 InUserWebApiContext, FNamedOnlineSession& InSession, const FOnDestroySessionCompleteDelegate& InCompletionDelegate)
		: PS4Subsystem(InPS4Subsystem)
		, UserWebApiContext(InUserWebApiContext)
		, Session(InSession)
		, CompletionDelegate(InCompletionDelegate)
...
{
public:
	FOnlineAsyncTaskPS4_LeaveRoom(FOnlineSubsystemPS4& PS4Subsystem, FNamedOnlineSession& InSession, const FOnDestroySessionCompleteDelegate& InDestroySessionDelegate, SceNpMatching2RequestId InRequestId);
...
{
public:
	FOnlineAsyncTaskPS4_SendSessionInvite(FOnlineSubsystemPS4& PS4Subsystem, const FUniqueNetIdPS4Ref& InUserId, const FNamedOnlineSession& InSession, const TArray<TSharedRef<const FUniqueNetId>>& InFriends);
...
{
public:
	FAsyncEventPS4_JoinSession(FOnlineSubsystemPS4& InPS4Subsystem, FUniqueNetIdPS4Ref InJoiningPlayerId, FName InSessionName, const FOnlineSessionSearchResult& InDesiredSession) 
		: FOnlineAsyncEvent(&InPS4Subsystem)
...
{
public:
	FAsyncEventPS4_JoinSessionComplete(FOnlineSubsystemPS4& InPS4Subsystem, FName InSessionName, const FOnlineSessionSearchResult& InDesiredSession, EOnJoinSessionCompleteResult::Type InResult) 
		: FOnlineAsyncEvent(&InPS4Subsystem)
		, SessionName(InSessionName)
		, DesiredSession(InDesiredSession)
		, Result(InResult)
...
{
public:
	FAsyncEventPS4_LeaveSessionComplete(FOnlineSubsystemPS4& InPS4Subsystem, FName InSessionName, bool bInWasSuccessful, const FOnDestroySessionCompleteDelegate& InCompletionDelegate) :
		FOnlineAsyncEvent(&InPS4Subsystem),
		SessionName(InSessionName),
		bWasSuccessful(bInWasSuccessful),
		CompletionDelegate(InCompletionDelegate)
