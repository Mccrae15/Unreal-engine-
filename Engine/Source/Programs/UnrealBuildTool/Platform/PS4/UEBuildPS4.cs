...
namespace UnrealBuildTool
{
	...
	class PS4PlatformSDK : UEBuildPlatformSDK
	{
		...
		public const string ExpectedSDKVersion = "6.008.001";

		// SDK version expected from a default install from SDK_Manager
		public const string ExpectedManuallyInstalledSDKVersion = "6.000";
		...
		public const uint MinimumSystemSoftwareVersion = 0x06008021u;
