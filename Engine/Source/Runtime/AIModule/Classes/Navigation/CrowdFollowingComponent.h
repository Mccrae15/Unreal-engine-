...
protected:
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="Crowd")	uint32 bEnableSlowdownAtGoal : 1;
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="Crowd")	uint32 bCanCheckMovingTooFar : 1;
