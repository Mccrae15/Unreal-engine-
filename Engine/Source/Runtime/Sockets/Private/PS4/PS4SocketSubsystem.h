...
public:
	...
	FPS4Socket(SOCKET InSocket, ESocketType InSocketType, const FString& InSocketDescription, const FName& InProtocolType, const bool bInIsP2P, ISocketSubsystem * InSubsystem)
