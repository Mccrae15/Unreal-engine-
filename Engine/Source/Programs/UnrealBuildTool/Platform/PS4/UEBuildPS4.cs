...
namespace UnrealBuildTool
{
	partial class PS4TargetRules
	{
		...
		/// <summary>
		/// Enables hdr scope support
		/// </summary>
		[ConfigFile(ConfigHierarchyType.Engine, "/Script/PS4PlatformEditor.PS4TargetSettings")]
		public bool bEnableHDRScopeSupport = false;
	...
	partial class ReadOnlyPS4TargetRules
	{
		...
		public bool bEnableHDRScopeSupport
		{
			get { return Inner.bEnableHDRScopeSupport; }
		}
...
#pragma warning restore CS1591
	...
	class PS4Platform : UEBuildPlatform
	{
		...
		public override void SetUpEnvironment(ReadOnlyTargetRules Target, CppCompileEnvironment CompileEnvironment, LinkEnvironment LinkEnvironment)
		{
			...
			if (Target.PS4Platform.bEnableHDRScopeSupport && Target.Configuration != UnrealTargetConfiguration.Shipping)
			{
				Log.TraceInformation("Compiling with HDR Scope support enabled.");
				LinkEnvironment.AdditionalLibraries.Add("SceHdrScopesDbg_stub_weak");
				CompileEnvironment.Definitions.Add("PS4_HDR_SCOPE_SUPPORT=1");
			}
			else
			{
				CompileEnvironment.Definitions.Add("PS4_HDR_SCOPE_SUPPORT=0");
			}
			...
			if (Target.Configuration != UnrealTargetConfiguration.Shipping || !Target.PS4Platform.bIsMakingFinalBuild)
			{
				...
				{
					CompileEnvironment.Definitions.Add("PS4_ENABLE_ASLR_STACKWALK=1");
				}
			}
			else
			{
	...
	class PS4PlatformSDK : UEBuildPlatformSDK
	{
		...
		public const string ExpectedSDKVersion = "6.508.001";

		// SDK version expected from a default install from SDK_Manager
		public const string ExpectedManuallyInstalledSDKVersion = "6.500";
		...
		public const uint MinimumSystemSoftwareVersion = 0x06510011u;
