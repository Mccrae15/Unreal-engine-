...
#include <sys/socket.h>
#include <net.h>
#define PLATFORM_NO_IPV6_SUPPORT
#endif
...
class IPAddress {
 public:
...
#if !defined(PLATFORM_NO_IPV6_SUPPORT)
  ...
  in_addr ipv4_address() const { return u_.ip4; }
  
#if !defined(PLATFORM_NO_IPV6_SUPPORT)
  in6_addr ipv6_address() const { return u_.ip6; }
#endif
...
#if !defined(PLATFORM_NO_IPV6_SUPPORT)
  InterfaceAddress(const ip6_type& ip6, int ipv6_flags)
...
#if defined(WEBRTC_ORBIS)
bool IPFromSceNetInAddr(SceNetInAddr* NetId, IPAddress* out);
#else
