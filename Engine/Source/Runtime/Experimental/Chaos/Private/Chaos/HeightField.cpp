...
namespace Chaos
{
	...
	bool FHeightField::GridSweep(const FVec3& StartPoint, const FVec3& Dir, const FReal Length, const TVector<FReal, 3> InHalfExtents, SQVisitor& Visitor) const
	{
	...
	bool FHeightField::SweepGeomImp(const QueryGeomType& QueryGeom, const FRigidTransform3& StartTM, const FVec3& Dir, const FReal Length, FReal& OutTime, FVec3& OutPosition, FVec3& OutNormal, int32& OutFaceIndex, const FReal Thickness, bool bComputeMTD) const
	{
		...
		GridSweep(StartPoint, Dir, Length, TVector<FReal, 3>(Inflation3D[0], Inflation3D[1], Inflation3D[2]), SQVisitor);
