...
public:
	...
	virtual void SetPredictionTiming(int32 FlipToDisplayLatency, int32 RenderFrameTime, bool bIs60Render120ScanoutMode, int32 CameraProcessStartTime, int32 UpdateMotionSensorDataStartTime) = 0;
};
