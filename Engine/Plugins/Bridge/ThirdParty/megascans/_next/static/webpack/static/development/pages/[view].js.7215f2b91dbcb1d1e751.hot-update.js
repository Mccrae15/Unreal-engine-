...
function useAssetDownload(assetOrAssets) {
  ...
  var getAssets = function getAssets(progressive) {
    ...
    if (Object.keys(assets).length > 1) {
      Object.keys(assets).map(function (id) {
        ...
        } else if (connected && Object(_Common_utils__WEBPACK_IMPORTED_MODULE_7__["getAuthTokenFromCookies"])()) {
  ...
  var startProgressiveDownloads = function startProgressiveDownloads() {
    var _getAssets = getAssets(true),
        ...
        _ = _getAssets2[0],
        assetsToDownload = _getAssets2[1]; // Have to get UAssetPreviews for assets that don't have those
...
//# sourceMappingURL=[view].js.7215f2b91dbcb1d1e751.hot-update.js.map