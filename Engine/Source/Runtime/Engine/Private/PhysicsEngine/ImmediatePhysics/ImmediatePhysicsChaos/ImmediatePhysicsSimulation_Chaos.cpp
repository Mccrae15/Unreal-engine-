...
float ChaosImmediate_Joint_SoftLinearStiffness = -1.0f;
float ChaosImmediate_Joint_SoftTwistStiffness = -1.0f;
float ChaosImmediate_Joint_SoftTwistDamping = -1.0f;
float ChaosImmediate_Joint_SoftSwingStiffness = -1.0f;
float ChaosImmediate_Joint_SoftSwingDamping = -1.0f;
float ChaosImmediate_Joint_LinearDriveStiffness = -1.0f;
float ChaosImmediate_Joint_LinearDriveDamping = -1.0f;
float ChaosImmediate_Joint_AngularDriveStiffness = -1.0f;
float ChaosImmediate_Joint_AngularDriveDamping = -1.0f;
