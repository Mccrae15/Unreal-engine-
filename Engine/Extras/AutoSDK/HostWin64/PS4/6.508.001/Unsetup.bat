...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\TMServer-6_50_0_9.msi" /norestart /quiet
...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_62_0_7790.msi" /norestart /quiet
REM CALL :HANDLE_ERROR
