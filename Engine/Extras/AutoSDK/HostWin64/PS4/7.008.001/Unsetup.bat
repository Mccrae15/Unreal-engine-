...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\TMServer-7_00_0_8.msi" /norestart /quiet
...
REM call msiexec /uninstall "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_70_0_8499.msi" /norestart /quiet
REM CALL :HANDLE_ERROR
