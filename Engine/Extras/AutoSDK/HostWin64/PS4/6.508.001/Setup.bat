...
:SKIPSCEROOTOVERRIDE
echo SCE_ORBIS_SDK_DIR=%CurrentFolder%NotForLicensees\6.500>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo SCE_ORBIS_SAMPLE_DIR=%CurrentFolder%NotForLicensees\6.500\target\samples>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
...
call "%CurrentFolder%NotForLicensees\Installers\PSFSD-6_1_184_16.exe" -install -silent
call "%CurrentFolder%NotForLicensees\Installers\TMServer-6_50_0_9.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_70_0_8499.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\Neighborhood-6_50_0_4.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\DebuggerRunnerForPS_Orbis-6_50_0_10.exe" -install -silent
