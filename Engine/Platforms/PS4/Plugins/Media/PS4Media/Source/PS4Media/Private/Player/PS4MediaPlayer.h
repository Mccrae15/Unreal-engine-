...
private:
	...
	/** Time of first sample decoded */
	TAtomic<FTimespan> FirstAudioSampleTime;

	/** Has current time already been set to the first audio sample decoded */
	bool HasSetTimeToFirstAudioSample;
};
