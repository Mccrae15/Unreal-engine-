...
public:
	...
	/**
	 * Choose track to select during initialize.
	 *
	 * @param TrackType Type of track.
	 * @param TrackIndex Index that will be used during initialize.
	 */
	void SetDesiredTrack(EMediaTrackType TrackType, int32 TrackIndex);
