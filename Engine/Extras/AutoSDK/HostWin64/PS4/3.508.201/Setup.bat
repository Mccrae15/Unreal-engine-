...
call "%CurrentFolder%NotForLicensees\Installers\TMServer-3_70_0_5.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-2_68_0_5609.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\Neighborhood-3_70_0_5.msi" /norestart /quiet
rmdir /s /q "C:\ProgramData\SCE\PSFSD"
