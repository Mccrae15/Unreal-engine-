...
void FNgs2SoundSource::PatchVoice(FNgs2Pathway* Pathway)
{
	...
	const bool bIsEQFilterApplied = (WaveInstance && WaveInstance->SoundClass) ? WaveInstance->SoundClass->Properties.bApplyEffects : false;
	if (PathwayName == ENgs2Pathway::TV && bIsEQFilterApplied && AudioDevice->EQVoice != SCE_NGS2_HANDLE_INVALID)
	{
