	...
	) const
{
	...
	// NV_MSCHOTT this looks funkyish there are a bunch of those sprinkled below
	...
	// NV_MSCHOTT this moved to SetupCommonViewUniformBufferParameters in 4.14
	...
	// NV_MSCHOTT what do do with this OutViewUniformBuffer = TUniformBufferRef<FViewUniformShaderParameters>::CreateUniformBufferImmediate(ViewUniformShaderParameters, UniformBuffer_SingleFrame);
}
