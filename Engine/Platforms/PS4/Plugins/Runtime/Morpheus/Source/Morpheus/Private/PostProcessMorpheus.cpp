...
#if MORPHEUS_ENGINE_DISTORTION && HAS_MORPHEUS_HMD_SDK
...
IMPLEMENT_GLOBAL_SHADER(FMorpheusPS, "/Plugin/Morpheus/Private/PostProcessHMDMorpheus.usf", "MainPS", SF_Pixel);
...
IMPLEMENT_GLOBAL_SHADER(FMorpheusVS, "/Plugin/Morpheus/Private/PostProcessHMDMorpheus.usf", "MainVS", SF_Vertex);

void FMorpheusHMD::CreateHMDPostProcessPass_RenderThread(FRDGBuilder& GraphBuilder, const FViewInfo& View, const FHMDDistortionInputs& Inputs, FScreenPassTexture& OutPass) const
{
	...
	OutPass = MoveTemp(Output);
}

#endif // MORPHEUS_ENGINE_DISTORTION && HAS_MORPHEUS_HMD_SDK