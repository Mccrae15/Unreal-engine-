...
protected:
	LAYOUT_FIELD(FShaderParameter, TargetHeight);
	LAYOUT_FIELD(FShaderParameter, ScaleFactorX);
	LAYOUT_FIELD(FShaderParameter, ScaleFactorY);
	LAYOUT_FIELD(FShaderParameter, TextureYOffset);
	LAYOUT_FIELD(FShaderResourceParameter, SrcTexture);

	LAYOUT_FIELD(FShaderResourceParameter, OutTextureRW);
};
