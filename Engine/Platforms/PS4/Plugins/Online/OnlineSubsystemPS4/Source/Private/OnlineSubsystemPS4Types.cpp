...
TSharedRef<FUniqueNetIdPS4> FUniqueNetIdPS4::FindOrCreate(const NpToolkit::Core::OnlineUser& OnlineUser)
{
	return FindOrCreate(OnlineUser.accountId, OnlineUser.onlineId);
}
