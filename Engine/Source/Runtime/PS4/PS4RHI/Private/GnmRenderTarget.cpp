...
namespace CopyTextureImpl
{
	...
	{
		TShaderMapRef< TCopyTexture2DCS<NumComponents> > ComputeShader(GetGlobalShaderMap(GMaxRHIFeatureLevel));
		...
		FIntPoint Size)
	{
		...
		// We always alias as UINTx for the copy
		...
		{
		case 1u: BindCopy2DShader<1u>(CmdContext, SrcTextureCopy, DestTextureCopy, SrcPos, FIntVector4(DestPos.X, DestPos.Y, Size.X, Size.Y)); break;
		case 2u: BindCopy2DShader<2u>(CmdContext, SrcTextureCopy, DestTextureCopy, SrcPos, FIntVector4(DestPos.X, DestPos.Y, Size.X, Size.Y)); break;
		case 4u: BindCopy2DShader<4u>(CmdContext, SrcTextureCopy, DestTextureCopy, SrcPos, FIntVector4(DestPos.X, DestPos.Y, Size.X, Size.Y)); break;
		default: check(false);
		}
...
void FGnmDynamicRHI::RHIMapStagingSurface(FRHITexture* TextureRHI,void*& OutData,int32& OutWidth,int32& OutHeight)
{
	FGnmSurface& Surface = GetGnmSurfaceFromRHITexture(TextureRHI);
...
void FGnmDynamicRHI::RHIUnmapStagingSurface(FRHITexture* TextureRHI)
{
}
...
FTexture2DRHIRef FGnmDynamicRHI::RHIGetFMaskTexture(FRHITexture* SourceTextureRHI)
{
