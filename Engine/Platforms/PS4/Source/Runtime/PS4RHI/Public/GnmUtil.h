...
inline void ResetBoundResources() {}
inline void StartVertexShaderVerification(FGnmVertexShader* Shader) {}
inline void StartPixelShaderVerification(FGnmPixelShader* Shader) {}
inline void TrackResource(uint32 ResourceType, uint32 ResourceIndex, Gnm::ShaderStage Stage) {}
inline void EndShaderVerification() {}
...
#else
inline void RequestRenderTargetVerification() {}
inline void VerifyRenderTargets(FGnmCommandListContext& GnmCommandContext, FGnmBoundShaderState* BoundShaderState) {}
#endif
