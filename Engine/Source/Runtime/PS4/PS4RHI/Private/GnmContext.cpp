...
uint64* FGnmCommandListContext::AllocateBeginCmdListTimestamp()
{
	...
	StartOfSubmissionTimestamp = reinterpret_cast<uint64*>(AllocateFromTempFrameBuffer(sizeof(uint64), 8));
...
uint64* FGnmCommandListContext::AllocateEndCmdListTimestamp()
{
	...
	EndOfSubmissionTimestamp = reinterpret_cast<uint64*>(AllocateFromTempFrameBuffer(sizeof(uint64), 8));
