...
#include "PS4/PS4PlatformProcess.h"
...
uint32 FPS4PlatformProcess::GetCurrentCoreNumber()
{
...
const TCHAR* FPS4PlatformProcess::UserSettingsDir()
{
...
bool FPS4PlatformProcess::ShouldSaveToUserDir()
{
	/** 
...
#include "PS4/PS4RunnableThread.h"
