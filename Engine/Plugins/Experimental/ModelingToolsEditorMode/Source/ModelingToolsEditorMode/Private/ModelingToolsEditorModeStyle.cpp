...
void FModelingToolsEditorModeStyle::Initialize()
{
	...
	// Tool Manager icons
	{
		...
		StyleSet->Set("ModelingToolsManagerCommands.BeginAddSphericalBoxPrimitiveTool", 			new IMAGE_BRUSH_SVG("Icons/ModelingSphericalBox", 		Icon20x20));
		StyleSet->Set("ModelingToolsManagerCommands.BeginAddSphericalBoxPrimitiveTool.Small", 		new IMAGE_BRUSH_SVG("Icons/ModelingSphericalBox",		Icon40x40));
		...
		StyleSet->Set("ModelingToolsManagerCommands.BeginCutMeshWithMeshTool",               new IMAGE_BRUSH_SVG("Icons/ModelingTrim", Icon20x20));
		StyleSet->Set("ModelingToolsManagerCommands.BeginCutMeshWithMeshTool.Small",         new IMAGE_BRUSH_SVG("Icons/ModelingTrim", Icon20x20));
