...
#ifndef SUPPORTED_AUDIO3D_PLATFORMS
#define SUPPORTED_AUDIO3D_PLATFORMS TEXT("")
#endif

bool FA3DPluginFactory::SupportsPlatform(const FString& PlatformName)
{
	static FString SupportedPlatforms[] = { SUPPORTED_AUDIO3D_PLATFORMS };

	for (int32 PlatformIndex = 0; PlatformIndex < UE_ARRAY_COUNT(SupportedPlatforms); ++PlatformIndex)
	{
		if (PlatformName == SupportedPlatforms[PlatformIndex])
		{
			return true;
		}
	}
