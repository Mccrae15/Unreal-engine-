...
/**
 * Type definition for shared references to instances of FPS4TargetDeviceOutput.
 */
typedef TSharedPtr<class FPS4TargetDeviceOutput, ESPMode::ThreadSafe> FPS4TargetDeviceOutputPtr;
