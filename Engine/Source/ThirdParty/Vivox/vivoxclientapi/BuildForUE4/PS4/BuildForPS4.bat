...
REM Build for PS4
echo Generating vivoxclientapi solution for VS2015 (PS4)...
if exist "%PS4_PATH%" (rmdir "%PS4_PATH%" /s/q)
mkdir "%PS4_PATH%"
cd "%PS4_PATH%"
cmake -G "Visual Studio 14 2015" -DCMAKE_TOOLCHAIN_FILE="%CMAKE_GLOBAL_DIR%\PS4\PS4.cmake" -DVIVOXSDK_PATH=../../vivox-sdk/Include -DCMAKE_SUPPRESS_REGENERATION=1 %PATH_TO_CMAKE_FILE%
