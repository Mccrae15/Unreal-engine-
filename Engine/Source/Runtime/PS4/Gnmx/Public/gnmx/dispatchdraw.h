	...
	namespace Gnmx
	{
		...
		*/
		...
		public:
			...
			uint8_t  m_numIndexBits;				///< The number of index bits. This should be set to the smallest value [1:16] such that <c>maxIndex < (1<<m_indexNumBits)</c>. It may always be set to 16 if instancing is disabled (that is, if <c>m_numInstancesMinus1 == 0</c>).
