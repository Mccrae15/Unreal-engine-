...
:SKIPSCEROOTOVERRIDE
echo SCE_ORBIS_SDK_DIR=%CurrentFolder%NotForLicensees\7.000>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
echo SCE_ORBIS_SAMPLE_DIR=%CurrentFolder%NotForLicensees\7.000\target\samples>>"%OutputEnvVarsFolder%OutputEnvVars.txt"
...
call "%CurrentFolder%NotForLicensees\Installers\PSFSD_2017_0_14_5.exe" -install -silent
call "%CurrentFolder%NotForLicensees\Installers\TMServer-7_00_0_8.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\PublishingTools-3_70_0_8499.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\Neighborhood-7_00_0_6.msi" /norestart /quiet
call "%CurrentFolder%NotForLicensees\Installers\DebuggerRunnerForPS_Orbis-7_00_0_7.exe" -install -silent
