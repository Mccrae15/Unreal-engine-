...
void* FGnmDynamicRHI::RHILockStagingBuffer(FRHIStagingBuffer* StagingBuffer, FRHIGPUFence* Fence, uint32 Offset, uint32 SizeRHI)
{
...
bool FGnmRenderQuery::BlockUntilComplete(bool& bSuccess)
{
	...
	SCOPED_NAMED_EVENT(FGnmRenderQuery_BlockUntilComplete, FColor::Red);
...
bool FGnmDynamicRHI::RHIGetRenderQueryResult(FRHIRenderQuery* QueryRHI, uint64& OutNumPixels, bool bWait, uint32 GPUIndex)
{
