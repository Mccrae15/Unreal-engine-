...
FSoftObjectPath FOculusAssetDirectory::AssetListing[] =
{
	...
	FString(TEXT("/OculusVR/Meshes/OculusGoController.OculusGoController")),
...
#if PLATFORM_ANDROID
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Oculus_Quest, ovrpSystemHeadset_Oculus_Quest, FOculusAssetDirectory::AssetListing[4] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Oculus_Quest, ovrpSystemHeadset_Oculus_Quest, FOculusAssetDirectory::AssetListing[5] },
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Oculus_Go, ovrpSystemHeadset_Oculus_Go, FOculusAssetDirectory::AssetListing[1] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Oculus_Go, ovrpSystemHeadset_Oculus_Go, FOculusAssetDirectory::AssetListing[1] },
#else 
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Rift_S, ovrpSystemHeadset_Oculus_Link_Quest, FOculusAssetDirectory::AssetListing[4] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Rift_S, ovrpSystemHeadset_Oculus_Link_Quest, FOculusAssetDirectory::AssetListing[5] },
		{ ovrpNode_HandLeft,  ovrpSystemHeadset_Rift_DK1, ovrpSystemHeadset_Rift_CB, FOculusAssetDirectory::AssetListing[2] },
		{ ovrpNode_HandRight, ovrpSystemHeadset_Rift_DK1, ovrpSystemHeadset_Rift_CB, FOculusAssetDirectory::AssetListing[3] },
#endif
	};
