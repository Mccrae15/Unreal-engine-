...
{
public:
	FGnmStagingBuffer(FVertexBufferRHIRef InBuffer)
	...
	void *Lock(uint32 Offset, uint32 NumBytes)
	{
		...
		return RHILockVertexBuffer(BackingBuffer, Offset, NumBytes, RLM_ReadOnly);
	}
	...
	void Unlock()
	{
		...
		RHIUnlockVertexBuffer(BackingBuffer);
	}
};
