...
void* FGnmDynamicRHI::RHILockIndexBuffer(FRHIIndexBuffer* IndexBufferRHI, uint32 Offset, uint32 Size, EResourceLockMode LockMode)
{
...
void FGnmDynamicRHI::RHIUnlockIndexBuffer(FRHIIndexBuffer* IndexBufferRHI)
{
	FGnmIndexBuffer* IndexBuffer = ResourceCast(IndexBufferRHI);
