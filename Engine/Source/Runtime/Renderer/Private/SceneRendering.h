...
protected:
	...
	void MobileTonemapSubpass(FRHICommandList& RHICmdList, const FViewInfo& View, const FIntPoint TargetSize, FRDGTexture* ColorGradingTexture, FRDGBuilder& GraphBuilder);
