...
class FOnlineAsyncTaskPS4TrackProfileUIStatus : public FOnlineAsyncTaskPS4
{
public:

	/** Constructor */
	FOnlineAsyncTaskPS4TrackProfileUIStatus(FOnlineSubsystemPS4& InSubsystem, const FOnProfileUIClosedDelegate& InProfileUIClosedDelegate)
	...
	{
		return FString::Printf(TEXT("FOnlineAsyncTaskPS4TrackProfileUIStatus bWasSuccessful: %d"), WasSuccessful());
	}
